...
import com.sandy.capitalyst.server.daemon.equity.recoengine.cfg.AttributeEvaluatorCfg ;
import com.sandy.capitalyst.server.daemon.equity.recoengine.cfg.RecoEngineCfg ;
import com.sandy.capitalyst.server.daemon.equity.recoengine.cfg.ScreenerCfg ;
...
public abstract class RecoEngineBase {
    ...
    private static final String SCREENER_PKG_PREFIX  = "com.sandy.capitalyst.server.daemon.equity.recoengine.screener." ;
    private static final String EVALUATOR_PKG_PREFIX = "com.sandy.capitalyst.server.daemon.equity.recoengine.evaluator." ;
    ...
    public boolean needsInitiaization() throws Exception {
