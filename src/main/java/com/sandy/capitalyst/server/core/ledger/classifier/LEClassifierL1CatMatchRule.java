...
public class LEClassifierL1CatMatchRule extends LEClassifierRule {

    private String regex = null ;
    private Pattern pattern = null ;
    
    public LEClassifierL1CatMatchRule( String ruleName, String regex ) {
        super( ruleName ) ;
    ...
    public String getMatchResult( LedgerEntry ledgerEntry ) {
        ...
        String cat = ledgerEntry.getL1Cat() ;
