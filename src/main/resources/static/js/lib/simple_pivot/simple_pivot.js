...
// <html>
//  <head>
//      <link rel="stylesheet" type="text/css" href="/res/style/jquery.treetable.css">
//      <link rel="stylesheet" type="text/css" href="/res/style/jquery.treetable.theme.css">
...
function PivotTable() {
    ...
    this.expandFirstLevel = function() {
        ...
        for( var i=0; i<nodes.length; i++ ) {
            var node = nodes[i] ;
            $( "#" + this.pivotTableId ).treetable( "expandNode", 
                           node.attributes[ "data-tt-id" ].nodeValue ) ;
        }
    }
